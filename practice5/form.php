          ...
          <div class="row mb-2 mt-4">
            ...
            <div class="col-md-4" id="abilities">
              ...
              <select class="form-select <?php print($err['abilities'] ? "is-invalid" : ($values['abilities'] ? "is-valid" : ""))?>" name="abilities[]" multiple="multiple">
                <option value="immortality" <?php print(!empty($values["abilities"]) && in_array("immortality", $values["abilities"]) ? "selected" : "")?>>Бессмертие</option>
                <option value="fireball" <?php print(!empty($values["abilities"]) && in_array("fireball", $values["abilities"]) ? "selected" : "")?>>Огненный шар</option>
                <option value="levitation" <?php print(!empty($values["abilities"]) && in_array("levitation", $values["abilities"]) ? "selected" : "")?>>Левитация</option>
              </select><br>
            </div>
